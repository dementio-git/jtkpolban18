...
function getRecordIdFromPath() {
  // Match new-style URL: /project-course/1/...
  let m = window.location.pathname.match(/project-course\/(\d+)(\/|$)/);
...
ProjectCourseDashboard.template =
  "jtk_project_course_base.ProjectCourseDashboard";

registry
  .category("actions")
  .add(
    "jtk_project_course_base.project_course_dashboard",
